                    ...
                    <div class="case-study-featured">
                        <div class="section-heading heading-left">
                            ...
                            <p>
                                ...
                                life and help you stand out in today's competitive marketplace. Let's embark on a creative
                                journey together and unlock the full potential of your brand.

                            </p>
                            <p>This version maintains the essence while being more concise.</p>
                        </div>
                        <div class="case-study-counterup">
                            <div class="single-counterup">
                                <h2 class="count-number">
                                    <span class="number count odometer odometer-auto-theme" data-count="10">
                            ...
                            <div class="single-counterup">
                                <h2 class="count-number">
                                    <span class="number count odometer odometer-auto-theme" data-count="1500">
                                        <div class="odometer-inside"><span class="odometer-digit"><span
                                                    class="odometer-digit-spacer">8</span><span
                                                    class="odometer-digit-inner"><span class="odometer-ribbon"><span
                                                            class="odometer-ribbon-inner"><span
    ...
    <section class="section-padding-equal">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 sal-animate" data-sal="slide-right" data-sal-duration="800" data-sal-delay="100">
                ...
                <div class="col-lg-5 sal-animate" data-sal="slide-left" data-sal-duration="800" data-sal-delay="100">
                    <div class="about-team">
                        <div class="section-heading heading-left">
